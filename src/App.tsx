...
import { Habit, HabitColor, User, HabitTemplate, BlogPost, ReactionType } from './types';
                      ...
                      return (
                        <>
                          ...
                          <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-full border transition-colors font-outfit font-medium ${
                              userReactionModal 
